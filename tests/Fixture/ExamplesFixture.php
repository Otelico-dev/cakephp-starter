...
class ExamplesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'example_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'is_published' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'BY_EXAMPLE_CATEGORY_ID' => ['type' => 'index', 'columns' => ['example_category_id'], 'length' => []],
            'BY_POSITION' => ['type' => 'index', 'columns' => ['position'], 'length' => []],
        ],
        '_constraints' => [
