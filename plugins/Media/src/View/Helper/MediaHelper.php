...
class MediaHelper extends Helper
{
     ...
     * @return string
     */
    public function iframe($ref, $refId,$options=array())
    {   
        ...
        return '<iframe src="' . $this->Url->build("/media/medias/index?ref=$ref&refId=$refId") . '" style="width:100%; height: '.$height.'; border: none;" id="medias-' . $ref . '-' . $refId . '"></iframe>';
    }
